...
class RolloutStorageAmp:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs, actions_shape, device="cpu"):
        self.device = device
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for _ in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield (
                    {key: value[batch_idx] for key, value in observations.items()},
                    actions[batch_idx],
                    values[batch_idx],
